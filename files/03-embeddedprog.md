...
![MCU Peripherals](../images/03_avrcpu-bus.png)
...
### processor families
  ...
  - [AVR](https://www.microchip.com/design-centers/8-bit/microchip-avr-mcus)
   ...
   - [RISC-V](https://cacm.acm.org/magazines/2020/5/244325-will-risc-v-revolutionize-computing/fulltext)
     - open architecture
     - [ESP32-C3](https://www.espressif.com/en/products/socs/esp32-c3), [ESP32-C6](https://www.espressif.com/en/products/socs/esp32-c6)
...
### packages
- [common packages](https://www.microchip.com/en-us/support/package-drawings)
  - DIP
  - SOT
  - SOIC
  - TSSOP
...
![IC packaging](../images/03_ic-packaging.jpg)
...
### Generative AI
  - Coding
    - [ChatGPT](https://chat.openai.com/), [Copilot](https://github.com/features/copilot), [Claude](https://claude.ai/), [Gemini](https://gemini.google.com/), [Deepseek](https://deepseekcoder.github.io/)
    - [bugs](http://academy.cba.mit.edu/classes/embedded_programming/AI/chat.mp4), [hallucination](http://academy.cba.mit.edu/classes/embedded_programming/AI/chat.mp4), [copyright infringement](http://academy.cba.mit.edu/classes/embedded_programming/AI/chat.mp4)
  - embedded
    - [LiteRT](https://ai.google.dev/edge/litert), [TinyML](https://www.tinyml.org/), [ESP-DL](https://github.com/espressif/esp-dl), [Edge Impulse](https://www.edgeimpulse.com/)
...
- [ATtiny412](http://academy.cba.mit.edu/classes/embedded_programming/t412/40001911A.pdf)
  ...
  - Pinout (for Arduino IDE)
    ![ATtiny412 Arduino pinout](../images/03_attiny412_ard-pinout.gif)
- [ATtiny45](http://academy.cba.mit.edu/classes/embedded_programming/Atmel-2586-AVR-8-bit-Microcontroller-ATtiny25-ATtiny45-ATtiny85_Datasheet.pdf)
  ...
  - Pinout (for Arduino IDE)
    ![ATtiny85 pinout](../images/03_attiny85_ard-pinout.jfif)
...
- [ATtiny1614](http://academy.cba.mit.edu/classes/embedded_programming/t1614/ATtiny1614-DataSheet-DS40001995B.pdf)
  ...
  - Pinout (for Arduino IDE)
    ![ATtiny1614 pinout](../images/03_attiny1614_ard-pinout.gif)
