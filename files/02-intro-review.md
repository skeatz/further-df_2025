...
## References
- [Fab Academy Diploma](http://fab.academany.org/2025/schedule.html)
- [MIT How to Make Almost Anything](http://fab.cba.mit.edu/classes/863.25/)
- [Fablab SP specific](http://fab.academany.org/2025/labs/singapore/)
...
- [(Optional)EasyEDA](https://easyeda.com/)
...
## Assignment
Create the a website for this module (wix, github) and pm the link for your website to me Telegram  group:
1. Create a basic website for the module. Your website must meet the following requirements:
   - be hosted on wix or github
...
You are free to use generative AI to help with your learning (e.g. learning about specific technology, programming). You must document clearly instances where genAI is used, uncluding:
- prompt used
- output generated by the genAI tool
